...
Route::middleware('auth')->group(function (){
    ...
    Route::prefix('pagos')->namespace('Payments')->group(function (){
        ...
        Route::post('/{invoice}/verificar-pago', 'PaymentsController@paymentVerification')->name('payment-verification');
        Route::post('/{invoice}/cancelar-verificion-pago', 'PaymentsController@cancelPaymentVerification')->name('cancel-payment-verification');
